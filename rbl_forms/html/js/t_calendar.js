...
var pathToImages = './img/t_calend/';	// Relative to your HTML file
...
function displayCalendar(inputField,format,buttonObj,displayTime,timeInput)
{
	...
	// RBL - Initialisation de la date si elle est invalide
	var d = new Date();
	if (isNaN(currentMonth) || currentMonth > 12 || currentMonth < 1) currentMonth = d.getMonth();
	if (isNaN(currentYear) || currentYear > 3000 || currentYear < 1000)  currentYear  = d.getFullYear() ;
	if (isNaN(tmpDay) || tmpDay > 31)       tmpDay = d.getDate() ;
	// FIN RBL
...
function displayCalendarName(n,format,buttonObj,displayTime,timeInput)
{
	...
	return displayCalendar(elt, format, buttonObj,displayTime,timeInput) ;
}
/* Fin ajout RBL */
