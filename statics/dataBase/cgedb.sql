...
CREATE TABLE IF NOT EXISTS `cge_db`.`OrdenDePago` (
  ...
  INDEX `fk_OrdenDePago_Usuarios1_idx` (`IdUsuario` ASC),
...
CREATE TABLE IF NOT EXISTS `cge_db`.`Pagos` (
  ...
  `IdOrdenDePago` INT(11) NOT NULL,
  PRIMARY KEY (`IdPago`),
  INDEX `fk_Pagos_OrdenDePago1_idx` (`IdOrdenDePago` ASC),
...
CREATE TABLE IF NOT EXISTS `cge_db`.`Aclaraciones` (
  ...
  INDEX `fk_Aclaraciones_Pagos1_idx` (`IdPago` ASC),
...
CREATE TABLE IF NOT EXISTS `cge_db`.`DatosDeFacturacion` (
  ...
  INDEX `fk_DatosDeFacturacion_Usuarios1_idx` (`IdUsuario` ASC),
...
CREATE TABLE IF NOT EXISTS `cge_db`.`DetalleOrdenDePago` (
  ...
  INDEX `fk_DetalleOrdenDePago_OrdenDePago1_idx` (`IdOrdenDePago` ASC),
  INDEX `fk_DetalleOrdenDePago_TipoDePago1_idx` (`IdTipoDePago` ASC),
...
CREATE TABLE IF NOT EXISTS `cge_db`.`Facturas` (
  ...
  INDEX `fk_Facturas_Pagos1_idx` (`IdPago` ASC),
  INDEX `fk_Facturas_DatosDeFacturacion1_idx` (`IdDatosDeFacturacion` ASC),
...
CREATE TABLE IF NOT EXISTS `cge_db`.`PagosRefrendados` (
  ...
  INDEX `fk_PagosRefrendados_Pagos1_idx` (`IdPago` ASC),
  INDEX `fk_PagosRefrendados_Refrendos1_idx` (`IdRefrendo` ASC),
...
CREATE TABLE IF NOT EXISTS `cge_db`.`Permisos` (
  ...
  INDEX `fk_Permisos_Roles1_idx` (`IdRole` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cge_db`.`UserRoles` ;
...
CREATE TABLE IF NOT EXISTS `cge_db`.`UserRoles` (
  ...
  INDEX `fk_Usuarios_Roles_Usuarios1_idx` (`Usuarios_IdUsuario` ASC),
  INDEX `fk_User_Roles_Roles1_idx` (`Roles_IdRole` ASC),
...
CREATE TABLE IF NOT EXISTS `cge_db`.`archivos` (
  ...
  `IdUsuario` INT(11) NOT NULL,
  `estado` INT(1) NULL DEFAULT 1 COMMENT '1: Espera\n2: Rechazado\n',
  `tipoDocumento` TINYTEXT NULL,
  `fechaCrea` DATE NULL,
  `fechaAct` DATE NULL,
