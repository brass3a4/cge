<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class AdminDocs_c extends CI_Controller{
		...
		function enviaMsj($idUsuario)
		{
			...
			$correos = array( $_POST['correoAspirante'], 'gest@xanum.uam.mx', 'nivon@xanum.uam.mx','aadministrativa_pv@virtuami.izt.uam.mx','rentzana@virtuami.izt.uam.mx','csep@xanum.uam.mx','csep@virtuami.izt.uam.mx');
			...
			$this->email->from('csep@virtuami.izt.uam.mx@virtuami.izt.uam.mx', 'Posgrado virtual');
