...
echo form_open('admin/usuarios/crear_usuario', $attributes);
?>
...
<p>
        ...
        <br /><input id="contrasena" type="password" name="contrasena" maxlength="32" value=""  />
</p>

<p>
        <label for="re_contrasena">Vuela a escribir su contraseña <span class="required">*</span></label>
        <?php echo form_error('re_contrasena'); ?>
        <br /><input id="re_contrasena" type="password" name="re_contrasena" maxlength="32" value=""  />
</p>
