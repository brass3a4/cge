			...
			<fieldset class="cuerpo">
				<fieldset>
					...
					<?php if(isset($datosUsuario['motivos'])):?>
						<label><b>Motivos para postular en el posgrado: </b><?=$datosUsuario['motivos']?></label>
					<?php endif ?>
					<?php if(isset($datosUsuario['interes'])):?>
						<label><b>Orientación de su interés: </b><?=$datosUsuario['interes']?></label>
					<?php endif ?>
					<?php if(isset($datosUsuario['interes2'])):?>
						<label><b>Otra orientación de su interés: </b><?=$datosUsuario['interes2']?></label>
					<?php endif ?>
					<?php if(isset($datosUsuario['proyecto'])):?>
						<label><b>Descripción del Proyecto: </b><?=$datosUsuario['proyecto']?></label>
					<?php endif ?>
					<?php if(isset($datosUsuario['medio'])):?>
						<label><b>Cómo se enteró del posgrado: </b><?=$datosUsuario['medio']?></label>
					<?php endif ?>
