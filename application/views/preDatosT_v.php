				...
				<fieldset>
					...
					<?php 
						switch ($datos['DatosUsuario_InstProcedencia']) {
							case '1':
									echo '<label><b>Comunidad: </b>UAM Iztapalapa</label>';	
								break;
							case '2':
									echo '<label><b>Comunidad: </b>UAM Xochimilco</label>';	
								break;
							case '3':
									echo '<label><b>Comunidad: </b>UAM Azcapozalto</label>';	
								break;
							case '4':
									echo '<label><b>Comunidad: </b>UAM Cuajimalpa</label>';	
								break;
							case '5':
