		...
		<div class="twelve columns ">
			...
			<fieldset class="cuerpo">
				...
				<fieldset>
					...
					<label><b>Nombre(s):</b> <?=$datos['Usuarios_Nombre']?></label>
					...
					<label><b>Lugar de nacimiento: </b><?=$datos['Usuarios_lugarNac'];?></label>
					<label><b>País: </b><?php
					...
					<!--<label><b>Ocupación Actual: </b><?=$datos['DatosUsuario_ocupacion']?></label>
					<label><b>Experiencia laboral: </b><?=$datos['DatosUsuario_experiencia']?></label>-->
					<label><b>Motivos para postular en el posgrado: </b><?=$datos['DatosUsuario_motivos']?></label>
					<label><b>Orientación de su interés: </b><?=$datos['DatosUsuario_interes']?></label>
					<label><b>Otra orientación de su interés: </b><?=$datos['DatosUsuario_interes2']?></label>
					<label><b>Descripción del Proyecto: </b><?=$datos['DatosUsuario_proyecto']?></label>
					<label><b>Cómo se enteró del posgrado: </b><?=$datos['DatosUsuario_medio']?></label>
